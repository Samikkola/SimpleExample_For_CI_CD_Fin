...
public class CreateUserDto
{
    ...
    [StringLength(100, MinimumLength = 3, ErrorMessage = "Etunimen tulee olla 3-100 merkkiä pitkä")]
    public string FirstName { get; set; } = string.Empty;

    [Required(ErrorMessage = "Sukunimi on pakollinen.")]
    [StringLength(100, MinimumLength = 3, ErrorMessage = "Sukunimen tulee olla 3-100 merkkiä pitkä")]
